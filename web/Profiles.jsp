		      	...
		      	<div class="container">
		            ...
		            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
		                <ul class="nav navbar-nav navbar-right">
		                    ...
		                    <li>
                                        <a class="page-scroll" href="logout" style="color:#F27935;" ><c:set var="loginOrLogout"value="${sessionScope.username==null ? 'Login':'Logout'}"/>${loginOrLogout}</a>
		                    </li>
		                </ul>
		            </div>  
		        </div> 
	            ...
	            <div class="row">
					<div class="col-lg-12 col-sm-12">
					    <div class="card hovercard">
					        ...
					        <div class="card-info"> <span class="card-title"><a href="Profiles">${name}</a></span>
					        </div>
					    </div>
					    <div class="btn-pref btn-group btn-group-justified btn-group-lg" role="group" aria-label="...">
					        <div class="btn-group" role="group">
					            <button type="button" id="stars" class="btn btn-default" href="Index.jsp#about" data-toggle="tab"><span class="fa fa-user" aria-hidden="true"></span>
					        ...
					        <div class="btn-group" role="group">
					            <button type="button" id="favorites" class="btn btn-default" href="Index.jsp#tab2" data-toggle="tab"><span class="fa fa-cutlery" aria-hidden="true"></span>
					        	...
					        	<div class="row">
					        		<div class="col-sm-8">
							        	<div class="table-responsive">
							        		...
							        		<tr>
							        			<td><a href="rewards.jsp"><h6>Rewards</h6></a></td>
							        		</tr>
							        		</table>
							        	</div>
					        		</div>

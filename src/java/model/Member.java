...
//    }
    ...
    public void Register(String name, String userName, String password, int age, String tel, String email, String sex, double height, double weight, String birthday) {
        ...
        try { 
            ...
            PreparedStatement pstm2 = con.prepareStatement("INSERT INTO PROFILE (USERNAME,PASSWORD,FULLNAME,AGE,TEL,EMAIL,SEX,HEIGHT,WEIGHT,BIRTHDAY) VALUES (?,?,?,?,?,?,?,?,?,?)");
            pstm2.setString(1, userName.toLowerCase());
    ...
    public void editProfile(int age, String name, String tel, String email, double height, double weight, String birthday) {
        try {
            Connection con = ConnectionBuilder.getConnection();
            PreparedStatement pstm = con.prepareStatement("UPDATE PROFILE SET FULLNAME=?,TEL=?,EMAIL=?,HEIGHT=?,WEIGHT=?,AGE = ?,BIRTHDAY=? WHERE CUST_ID = ?");

...
public class rewards extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        Statement s = null;
        Long log = (Long) session.getAttribute("coin");
        
        String coin="";
        if (log != null) {
            try {
                s = con.createStatement();
                String sql = "SELECT * FROM  profile WHERE coin =" + log;
                ResultSet rec;
...
//                getServletContext().getRequestDispatcher("/rewards.jsp").forward(request, response);

...
public class Profiles extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (log != null) {
            ...
            String sql = "SELECT * FROM  profile WHERE cust_Id =" + log;
            ResultSet rec;
...
//            getServletContext().getRequestDispatcher("/rewards").include(request, response);
//            getServletContext().getRequestDispatcher("/rewards").forward(request, response);
            if(session == null){
